...
public enum ADC {
    ...
    public enum VoltageReferenceSelection: UInt8 {
        case AnalogReferenceInternalVrefTurnedOff = 0
...
public struct AnalogeDigitalConverter: AVRADC {
    ...
    public static var MultiplexerSelectionRegister: UInt8 { //ADMUX
        get {
            return _rawPointerRead(address: 0x7C)
        }
        set {
    ...
    @inlinable
    @inline(__always)
    public static var ControlAndStatusRegisterB: UInt8 { //ADCSRA
        get {
            return _rawPointerRead(address: 0x7B)
        }
        set {
    ...
    public static var ControlAndStatusRegisterA: UInt8 { //ADCSRA
        get {
            return _rawPointerRead(address: 0x7A)
        }
        set {
    ...
    public static var ADCH: UInt8 { //ADCSRA
        get {
            return _rawPointerRead(address: 0x79)
        }
        set {
  ...
  @inlinable
    ...
    public static var ADCL: UInt8 { //ADCSRA
        get {
            return _rawPointerRead(address: 0x78)
        }
        set {
    ...
    public static var DigitalInputDisableRegister0: UInt8 { //DIDR0
        get {
            return _rawPointerRead(address: 0x7E)
        }
        set {
...
extension AVRADC {
    ...
    @inlinable
    @inline(__always)
    static var voltageReferenceSelection: ADC.VoltageReferenceSelection { // REFS[1:0]
        get {
            let mode = (MultiplexerSelectionRegister & 0b11000000) >> 6
            return ADC.VoltageReferenceSelection.init(rawValue: mode) ?? .AnalogReferenceInternalVrefTurnedOff
        }
        set {
    ...
    @inlinable
    @inline(__always)
    static var leftAdjustResult: Bool { //ADLAR
        get {
    ...
    @inlinable
    @inline(__always)
    static var analogChannelSelectionBits: ADC.AnalogChannelSelectionBits { // MUX[3:0]
        get {
    ...
    @inlinable
    @inline(__always)
    static var enableADC: Bool { //ADEN
        get {
    ...
    @inlinable
    @inline(__always)
    static var startConversion: Bool { //ADSC
        get {
            return !((ControlAndStatusRegisterA & 0b01000000) == 0)
        }
        set {
            ControlAndStatusRegisterA = (ControlAndStatusRegisterA & ~0b01000000) | (((newValue == true) ? 1 : 0) << 6 & 0b01000000)
        }
    }
    ...
    @inlinable
    @inline(__always)
    static var autoTriggerEnable: Bool { //ADATE
        get {
    ...
    @inlinable
    @inline(__always)
    static var interruptFlag: Bool { //ADIF
        get {
    ...
    @inlinable
    @inline(__always)
    static var interruptEnable: Bool { //ADIE
        get {
    ...
    @inlinable
    @inline(__always)
    static var prescalerSelectBits: ADC.PrescalerSelectBits { // ADPS[2:0]
        get {
    ...
    @inlinable
    @inline(__always)
    static var DataRegister: UInt16 {
        get {
    ...
    @inlinable
    @inline(__always)
    static var autoTriggerSource: ADC.AutoTriggerSource { // ADTS[2:0]
        get {
    ...
    @inlinable
    @inline(__always)
    static var digitalInputDisable5: Bool { //ADC5D
        get {
    ...
    @inlinable
    @inline(__always)
    static var digitalInputDisable4: Bool { //ADC4D
        get {
    ...
    @inlinable
    @inline(__always)
    static var digitalInputDisable3: Bool { //ADC3D
        get {
    ...
    @inlinable
    @inline(__always)
    static var digitalInputDisable2: Bool { //ADC2D
        get {
    ...
    @inlinable
    @inline(__always)
    static var digitalInputDisable1: Bool { //ADC1D
        get {
    ...
    @inlinable
    @inline(__always)
    static var digitalInputDisable0: Bool { //ADC0D
        get {
